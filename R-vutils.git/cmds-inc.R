...
# Add a footnote to an existing plot. Adapted from:
# http://bigdata-analyst.com/best-way-to-add-a-footnote-to-a-plot-created-with-ggplot2.html

make.footnote <- function (text=format(Sys.time(), "%d %b %Y"),
                           size = .7, color = grey(.5)) {
  require (grid)
